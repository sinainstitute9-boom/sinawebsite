...
//   useEffect(() => {
//     client.fetch(jobBySlugQuery, { slug }).then(setJob);
//   }, [slug]);
...
//         <h1 className="text-3xl font-bold text-[#074166] mb-4">
//           {job.title} - Apply Now
//         </h1>
...
//       {fields.length === 0 && (
//         <p className="text-gray-700">Please fill your details and submit.</p>
//       )}
