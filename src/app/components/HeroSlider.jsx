    ...
    <section className="relative h-screen w-full overflow-hidden object-cover mt-16">
      ...
      <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-6">
        <div className="max-w-4xl">
          ...
          >
            {slides[index].title}{" "}
            <span className="text-[#fdad1b] drop-shadow-lg">
          ...
          <motion.p
            ...
            className="mt-6 text-3xl text-gray-200 drop-shadow-lg"
          >
            {slides[index].desc}
          </motion.p>

          <Link href="/courses" className="mt-8 inline-block bg-[#fdad1b] text-black px-8 py-3 rounded-full font-semibold hover:scale-110 transition">
            Learn More
          </Link>
