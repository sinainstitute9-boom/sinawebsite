    ...
    <section className="relative z-10 -mt-24 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto bg-[#074166] text-white rounded-2xl shadow-2xl p-8 md:p-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10">
          <Link href="/aboutus" className="bg-[#fbae1a] text-[#074166] px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition text-center">
            Read More
          </Link>

          <a href="tel:+923203400111" className="border-2 border-[#fbae1a] text-[#fbae1a] px-6 py-3 rounded-lg font-semibold hover:bg-[#fbae1a] hover:text-[#074166] transition text-center">
            +92 3203400111
          </a>
        </div>
